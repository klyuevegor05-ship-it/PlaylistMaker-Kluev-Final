...
fun PlaylistNavHost(
    ...
    NavHost(navController = navController, startDestination = Screen.MAIN.name) {
        composable(Screen.MAIN.name) {
            MainScreen(
                onSearchSelected = { navController.navigate(Screen.SEARCH.name) },
                onPlaylistsSelected = { navController.navigate(Screen.PLAYLISTS.name) },
                onFavoritesSelected = { navController.navigate(Screen.FAVORITES.name) },
                onSettingsSelected = { navController.navigate(Screen.SETTINGS.name) },
